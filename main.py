    ...
    async with aiohttp.ClientSession(timeout=timeout) as session:
        ...
        try:
            ...
            leads_params_1 = {
                ...
                'select': ['ID', 'OPPORTUNITY', 'STATUS_ID', 'UF_CRM_1717008267006', 'TITLE', 'DATE_CREATE', 'CONTACT_ID', 'PHONE', 'UF_CRM_1717008267006', 'UF_CRM_1716238809742', 'UF_CRM_1721931621996', 'UF_CRM_672386F259715']
            }
            leads_params_2 = {
